...
def test_construct_job_params():
    bag_creator = BagCreator("dart_command", "workflow")
...
def test_run_method(mocker):
    ...
    create_bag = BagCreator("dart_command", "workflow").run(
        "329d56f6f0424bfb8551d148a125dabb", "ao_uri", "1950-01-01", "1955-12-13", [2, 4], ["/path/to/file1.tif", "/path/to/file2.tif"])
    assert create_bag
